...
def compute_thresholds(
    ...
    for key, g in grouped:
        ...
        if weights_col and weights_col in g.columns:
            ...
            p5 = weighted_quantile(g[value_col], tourist_weights, 0.05)
            p95 = weighted_quantile(g[value_col], tourist_weights, 0.95)
        else:
            n_turisti = n
            p5 = float(vals.quantile(0.05)) if n > 0 else None
            p95 = float(vals.quantile(0.95)) if n > 0 else None
    ...
    *,
    ...
    meta = pd.DataFrame(
        [
            ...
            {
                "metrica": "soglie_pesate",
                "valore": "p5 e p95 calcolati con quantili pesati su numero_componenti",
            },
            {
